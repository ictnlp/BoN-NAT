...
parser.add_argument('--alph',type=float, default=0.1)
parser.add_argument('--joint',     action='store_true', default=False)
parser.add_argument('--ng_finetune',     action='store_true', default=False)
...
if args.dataset != "mscoco":
    vocab_path = data_prefix / 'vocab' / '{}_{}_{}_{}.pt'.format('{}-{}'.format(args.src, args.trg), args.vocab_size, 'shared' if args.share_vocab else '', 'strong' if args.strong else '')
